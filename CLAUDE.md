...
PMC News is a modern news website built with Next.js 15, featuring dark mode support, mobile-responsive design, and static site generation. The site displays mock news articles across multiple categories with a clean, professional interface.
